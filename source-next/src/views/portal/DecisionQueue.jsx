          ...
          return (
            <div key={item.id} className="bg-slate-900 rounded-xl border border-slate-800 p-6">
              ...
              <div className="flex gap-2 mb-4 flex-wrap">
                ...
                <Link href={`/portal/requests/${item.id}/feasibility`} className="ml-auto px-4 py-2 bg-blue-500/10 border border-blue-500/30 text-blue-400 rounded-lg text-sm hover:bg-blue-500/20 transition-colors">
                  Full Review →
                </Link>
              </div>
