  ...
  return (
    <div className="p-8 max-w-6xl">
      ...
      <div className="flex items-center gap-4 mb-6">
        <Link href="/portal/requests/PR-0041" className="flex items-center gap-2 text-slate-400 hover:text-slate-200 text-sm">
      ...
      <div className="flex flex-wrap gap-2 mt-4">
        {[
          ...
          <Link key={l.path} href={l.path} className="px-3 py-1.5 bg-slate-800 border border-slate-700 text-slate-400 rounded-lg text-xs hover:bg-slate-700 hover:text-slate-200 transition-colors">{l.label}</Link>
        ))}
      </div>
