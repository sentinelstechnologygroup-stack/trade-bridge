    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6">
      <div className="text-center max-w-md">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/portal" className="flex items-center justify-center gap-2 px-5 py-2.5 bg-amber-500 text-slate-950 rounded-lg text-sm font-semibold hover:bg-amber-400">
            <LayoutDashboard className="w-4 h-4" /> Return to Dashboard
          </Link>
          <Link href="/contact" className="flex items-center justify-center gap-2 px-5 py-2.5 bg-slate-800 border border-slate-700 text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-700">
