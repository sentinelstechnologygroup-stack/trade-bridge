  ...
  return (
    <div className="p-8">
      ...
      <div className="flex gap-3 mb-8 flex-wrap">
        <Link href="/portal/quote-builder" className="flex items-center gap-2 px-4 py-2 bg-amber-500 text-slate-950 rounded-lg text-sm font-semibold hover:bg-amber-400 transition-colors">
        ...
        <Link href="/portal/requests" className="flex items-center gap-2 px-4 py-2 bg-slate-800 text-slate-100 rounded-lg text-sm font-medium hover:bg-slate-700 transition-colors border border-slate-700">
          Requests Inbox
        </Link>
      </div>
            ...
            <tbody>
              {requests.map((r) => (
                <tr key={r.id} className="border-b border-slate-800/50 hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="px-5 py-4">
                    <Link href={`/portal/requests/${r.id}`} className="text-xs text-amber-400 hover:text-amber-300 whitespace-nowrap">View →</Link>
                  </td>
                </tr>
              ))}
            </tbody>
