  ...
  return (
    <div className="p-8 max-w-6xl">
      <div className="flex items-center gap-4 mb-6">
        <Link to="/portal/requests" className="flex items-center gap-2 text-slate-400 hover:text-slate-200 text-sm">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-900 rounded-xl border border-slate-800 p-5">
            ...
            <div className="space-y-2">
              <Link to={`/portal/requests/${req.id}/feasibility`} className="flex items-center gap-2 w-full px-4 py-2.5 bg-blue-500/15 border border-blue-500/30 text-blue-400 rounded-lg text-sm font-medium hover:bg-blue-500/25 transition-colors">
                <Brain className="w-4 h-4" /> Start Feasibility Review
              </Link>
              <Link to="/portal/clients" className="flex items-center gap-2 w-full px-4 py-2.5 bg-slate-800 border border-slate-700 text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-700 transition-colors">
                View Client
              </Link>
              <Link to="/portal/importer-profiles" className="flex items-center gap-2 w-full px-4 py-2.5 bg-slate-800 border border-slate-700 text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-700 transition-colors">
                View Importer Profile
              </Link>
              <Link to="/portal/compliance-review" className="flex items-center gap-2 w-full px-4 py-2.5 bg-orange-500/15 border border-orange-500/30 text-orange-400 rounded-lg text-sm font-medium hover:bg-orange-500/25 transition-colors">
                Open Compliance Review
              </Link>
              <Link to="/portal/documents" className="flex items-center gap-2 w-full px-4 py-2.5 bg-slate-800 border border-slate-700 text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-700 transition-colors">
                View Documents
              </Link>
              <Link to="/portal/tasks" className="flex items-center gap-2 w-full px-4 py-2.5 bg-slate-800 border border-slate-700 text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-700 transition-colors">
                View Tasks
              </Link>
            </div>
          </div>
