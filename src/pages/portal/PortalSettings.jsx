  ...
  return (
    <div className="p-8 max-w-5xl">
      <div className="mb-6">
        ...
        <Link to="/portal/risk-rules" className="flex items-center gap-2 px-4 py-2 bg-slate-800 border border-slate-700 text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-700 hover:text-white transition-colors">
